...
<tr>
	...
	<h2>상품정보수정</h2>
	<form name="editForm">
	<input type="text" name="arg1" value="<%=pCode%>">
		<table border="1" align="center" width="50%">
			...
			<tr>
				<td>상품가격</td>
				<td><input type="number" name="pPrice" value="<%= pPrice %>"></td>
			</tr>
			<tr>
				<td>상품설명</td>
				<td><input type="text" name="pContent" value="<%= pContent %>"></td>
			</tr>
			<tr>
				<td>카테고리</td>
				<td><%= pCategory %></td>
			...
			<tr>
				<td>제조사</td>
				<td><input type="text" name="pVendor" value="<%= pVendor %>"></td>
			</tr>
			<tr>
				<td colspan="2" align="center">
				<button type="button" onClick="pEdit();">수정하기</button>
				</td>
			</tr>
		...
		|
		<a href="#" onClick="move('edit.jsp');">수정</a>
		|
...
<script>
function pEdit() {
	document.editForm.action="editProc.jsp";
