...
<table border="1" align="center">
	...
	<tr>
		<td>주민번호</td>
		<td>
			<input type="text" name="jumin1" style="width: 71px;">
			-
			<input type="text" name="jumin2" style="width: 71px;">
		</td>
	</tr>
	<tr>
		<td>주소</td>
...
function join() {
	if(confirm('등록할까요?')) {
		document.insertForm.enctype = "multipart/form-data";
		document.insertForm.action = "mainProc.jsp?menuGubun=member_attachInsertProc";
