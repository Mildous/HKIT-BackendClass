...
<div style="padding-top: 20px; width: 80%; " align="left">
	...
	%>
			<td><a href="#" onClick="move('subBoard_view', '<%= dto.getPreNo() %>');"><%= dto.getPreSubject() %></a></td>
	<%		
		}
	%>	
		</tr>
	...
	%>
			<td><a href="#" onClick="move('subBoard_view', '<%= dto.getNxtNo() %>');"><%= dto.getNxtSubject() %></a></td>
	<%		
		}
	%>	
		</tr>
...
<div style="padding-top: 20px; width: 80%; " align="right">
	|
	<a href="#" onClick="move('subBoard_insert', '<%= no %>');">답변글달기</a>
	|
	<a href="#" onClick="move('subBoard_list', '');">목록</a>
	|
	<a href="#" onClick="move('subBoard_write', '');">등록</a>
	|
	<a href="#" onClick="move('subBoard_update', '<%= dto.getNo() %>');">수정</a>
	|
	<a href="#" onClick="move('subBoard_delete', '<%= dto.getNo() %>');">삭제</a>
	|
</div>
<%	} %>
<script>
