 ...
 * Generated at: 2022-09-02 02:38:07 UTC
...
public final class cartAdd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/shopMall/_inc_top.jsp", Long.valueOf(1662085778228L));
...
*/
   ...
   int productCode1 = Integer.parseInt(productCode_);
   
   String amount_=request.getParameter("amount");
   int amount=Integer.parseInt(amount_);
   
   CartDTO setDto=new CartDTO();
   setDto.setProductCode(productCode1);
   setDto.setAmount(amount);
   setDto.setMemberNo(sessionNo);
   
   CartDAO setDAO=new CartDAO();
   int result=setDAO.setInsert(setDto);
   
   
   if(result>0){
      out.print("<script>");
      out.print("alert('장바구니에 담김');");
      out.print("location.href='main.jsp?menuGubun=shopMall_view&productCode="+productCode1+"';");
      out.print("</script>");
   }else{
      out.print("<script>");
      out.print("alert('장바구니에 안 담김');");
      out.print("location.href='main.jsp?menuGubun=shopMall_view&productCode="+productCode1+"';");
      out.print("</script>");
   }
