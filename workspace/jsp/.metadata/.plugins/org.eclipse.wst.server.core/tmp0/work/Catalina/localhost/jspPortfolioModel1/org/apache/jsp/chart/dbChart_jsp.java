 ...
 * Generated at: 2022-09-13 03:53:36 UTC
...
public final class dbChart_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/chart/../_include/inc_header.jsp", Long.valueOf(1662616070258L));
...
*/
	...
	String chartCurveType = ""; //function
      ...
      out.write("  google.charts.setOnLoadCallback(drawChart); //로딩이 끝나면 drawChart()를 호출해라..\n");
      out.write("\n");
      out.write("  function drawChart() {\n");
      out.write("  	var url = \"mainProc.jsp?menuGubun=chart_dbChartProc\";\n");
      out.write("	var jsonData = $.ajax({\n");
      out.write("		url : url,\n");
      out.write("		dataType : \"json\",\n");
      out.write("		async : false \n");
      out.write("	}).responseText; //responseText; <- 서버에서 응답한 텍스트\n");
      out.write("    console.log(jsonData);\n");
      out.write("  //데이타 테이블 생성\n");
      out.write("    var data = new google.visualization.DataTable(jsonData);\n");
      out.write("    \n");
      out.write("    var options = {\n");
      out.write("      title : '");
      out.print(chartTitle );
      out.write("',\n");
      out.write("      curveType : \"");
      out.print(chartCurveType );
      out.write("\",\n");
      out.write("      width : 900,\n");
      out.write("      height : 500\n");
      out.write("    };\n");
      out.write("\n");
      out.write("    var chart = new google.visualization.");
      out.print(chartType );
