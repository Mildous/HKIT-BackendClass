...
%>
	<tr>
		<td colspan="8" height="200px" align="center">
			등록된 게시물이 없습니다..
		</td>
	</tr>
<%
...
%>
	...
	%>
		<td><%= blankValue %><a href="#" onclick="move('subBoard_view', '<%= dto.getTbl() %>', '<%= dto.getNo() %>');" ><%= imsiSubject %></a></td>
		<td><%= dto.getWriter() %></td>
...
<div style="padding-top: 20px; width: 80%;" align="right">
	...
	|
	<a href="#" onclick="move('subBoard_insert', '<%= tbl %>', '');">등록</a>
	|
</div>
