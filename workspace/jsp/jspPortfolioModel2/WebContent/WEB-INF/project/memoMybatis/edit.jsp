...
<form name="DirForm" method="post" action="${ path }/memoMybatis_servlet/memoMybatis_editProc.do">
...
<table border="1" align="center" width="60%">
	...
	<tr>
		<td colspan="2" align="center" style="height: 50px;">
			...
			<button type="button" onclick="move('memoMybatis_view.do', '${ dto.no }');">취소</button>
		</td>
	</tr>
</table>
</form>
