...
<form name="DirForm" method="post" action="${ path }/member_servlet/member_editProc.do?${ searchQuery }" onsubmit="validateForm(this)">
...
<table border="1" align="center" width="80%">
	...
	<tr>
		...
		<td>
			<input type="text" id="sample6_postcode" name="sample6_postcode" placeholder="우편번호" value="${ dto.postcode }" readonly>
			<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기">
		</td>
	</tr>
	<tr>
		<td>
			<input type="text" id="sample6_address" name="sample6_address" placeholder="주소" value="${ dto.address }" readonly>
		</td>
	</tr>
	<tr>
		<td>
			<input type="text" id="sample6_detailAddress" name="sample6_detailAddress" placeholder="상세주소" value="${ dto.detailAddress }">
			<input type="text" id="sample6_extraAddress" name="sample6_extraAddress" placeholder="참고항목" value="${ dto.extraAddress }" readonly>
		</td>
	</tr>
	<tr>
