...
function idCheckWin() {
	window.open("${ path }/member_servlet/member_idCheckWin.do", "idCheckWin", "width=600, height=210, toolbar=no, scrollbars=no, resizable=yes");
}
</script>
<h2>회원등록</h2>
...
<table border="1" align="center" width="80%">
	...
	<tr>
		<td colspan="2" align="center" style="height: 50px;">
			...
			<button type="button" onclick="location.href='${ path }/member_servlet/member_list.do?pageNum=${ pageNum }&no=&${ searchQuery }'">목록으로</button>
		</td>
	</tr>
</table>
</form>
