...
<div style="padding-top: 20px; width: 80%; " align="right">
	...
	|
	<a href="#" onClick="move('board_write', '', '<%= searchField %>', '<%= searchWord %>');">등록</a>
	|
	<a href="#" onClick="move('board_edit', '<%= dto.getNo() %>', '<%= searchField %>', '<%= searchWord %>');">수정</a>
	|
	<a href="#" onClick="move('board_delete', '<%= dto.getNo() %>', '<%= searchField %>', '<%= searchWord %>');">삭제</a>
	|
</div>
