...
<table border="1" width="80%" align="center">
	...
	<tr>
		<th>주소</th>
		<td>
			<input type="text" id="sample6_postcode" placeholder="우편번호" name="addr1" readonly>
			<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
			<input type="text" id="sample6_address" placeholder="주소" name="addr2" readonly><br>
			<input type="text" id="sample6_detailAddress" placeholder="상세주소" name="addr3">
			<input type="text" id="sample6_extraAddress" placeholder="참고항목" name="addr4" readonly>
		</td>
	</tr>
	<tr>
	...
	<input type="hidden" name="post1" value="<%= resultDto.getAddr1() %>">
	<input type="hidden" name="post2" value="<%= resultDto.getAddr2() %>">
	<input type="hidden" name="post3" value="<%= resultDto.getAddr3() %>">
	<input type="hidden" name="post4" value="<%= resultDto.getAddr4() %>">
</form>
...
<script>
function formSubmit() {
	if(document.DirForm.addr1.value != "" && document.DirForm.addr3.value != "") {
		document.DirForm.post1.value = document.DirForm.addr1.value;
		document.DirForm.post2.value = document.DirForm.addr2.value;
		document.DirForm.post3.value = document.DirForm.addr3.value;
		document.DirForm.post4.value = document.DirForm.addr4.value;	
	}
